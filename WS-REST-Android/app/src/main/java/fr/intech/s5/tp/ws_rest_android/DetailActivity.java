...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Les images existent déjà dans le répertoire assets.
        //On va les chercher dans ce répertoire
        //Une autre alternatif existe qui est de saucegarder les images depuis la gestion
        //avec picasso en utilisant un objet de type target
